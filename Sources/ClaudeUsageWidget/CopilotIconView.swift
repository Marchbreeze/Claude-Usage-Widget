...
struct CopilotIconView: View {
    ...
    var body: some View {
        Canvas { context, size in
            ...
            func corner(_ cw: CGFloat, _ ch: CGFloat) -> CGSize { CGSize(width: cw * w, height: ch * h) }
            ...
            // Side ears.
            path.addRoundedRect(in: r(0.0, 0.40, 0.14, 0.24), cornerSize: corner(0.05, 0.05))
            path.addRoundedRect(in: r(0.86, 0.40, 0.14, 0.24), cornerSize: corner(0.05, 0.05))
            // Head.
            path.addRoundedRect(in: r(0.12, 0.20, 0.76, 0.66), cornerSize: corner(0.20, 0.20))
